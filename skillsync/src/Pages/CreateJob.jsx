...
const CreateJob = () => {
  ...
  const {
    ...
    defaultValues: {
      postedby: userEmail, // Set the default value for "postedby" here
    },
  });

  const onSubmit = (data) => {
    if (!data.jobTitle || !data.description || !data.jobLocation ||  !data.companyName || !data.minPrice || !data.maxPrice || !data.salaryType || !data.jobLocation || !data.jobLocation || !data.experienceLevel || !data.postingDate) {
